...
class FolderTreeWidget(QTreeWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self.expanded_paths: Optional[Set[str]] = None     # 展開済みパスのセット
        self.indexing_paths: Optional[Set[str]] = None     # インデックス処理中パスのセット
        self.indexed_paths: Optional[Set[str]] = None      # インデックス済みパスのセット
        self.excluded_paths: Optional[Set[str]] = None     # 除外パスのセット
        self.error_paths: Optional[Set[str]] = None        # エラー状態パスのセット
