...
from PySide6.QtCore import (QDate, QEasingCurve, QPoint, QPropertyAnimation,
                            QRect, QSize, QStringListModel, Qt, QThread,
                            QTimer, Signal)
from PySide6.QtGui import (QAction, QColor, QFont, QFontMetrics, QIcon,
                           QKeySequence, QPalette, QPixmap,
                           QRegularExpressionValidator, QShortcut, QValidator)
from PySide6.QtWidgets import (QButtonGroup, QCheckBox, QComboBox, QCompleter,
...
from ..data.models import FileType, SearchQuery, SearchType
...
class SearchInterface(QWidget):
    ...
    def _clear_all(self) -> None:
        ...
        try:
            ...
            # 履歴表示をクリア（必要に応じて）
            # self.history_widget.clear_recent_searches()
