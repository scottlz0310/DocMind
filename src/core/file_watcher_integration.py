...
class DocumentIndexingService:
    ...
    def __init__(self, config: Config | None = None):
        ...
        # コールバック関数
        self.on_document_added: Callable[[str], None] | None = None
        self.on_document_updated: Callable[[str], None] | None = None
    ...
    def initial_scan(self, directory_paths: list[str] | None = None) -> dict[str, Any]:
        """
        初期スキャンを実行
    ...
    def force_rescan(self, directory_path: str | None = None) -> None:
        """
        強制再スキャンを実行
