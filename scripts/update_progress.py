...
def create_session_template() -> dict:
    ...
    return {
        "session_number": 1,
        "work_done": ["依存関係分析スクリプト実行", "folder_tree.py完全分析"],
        "deliverables": ["folder_tree_dependencies.json", "FOLDER_TREE_ANALYSIS.md"],
        "week_progress": {
            "week": 0,
            "day": 1,
            "completed_hours": 6,
        ...
        "overall_progress": {"percent": 5, "completed_weeks": 0},
        "next_tasks": [
