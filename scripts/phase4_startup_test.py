...
def test_component_imports():
    ...
    try:
        ...
        from gui.folder_tree.state_management.folder_item_type import FolderItemType
        from gui.folder_tree.ui_management.ui_setup_manager import UISetupManager
        from gui.folder_tree.event_handling.event_handler_manager import EventHandlerManager
