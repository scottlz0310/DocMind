...
from src.utils.error_handler import ErrorHandler, get_global_error_handler
from src.utils.graceful_degradation import GracefulDegradationManager, get_global_degradation_manager
from src.utils.exceptions import SearchError, IndexingError, DocumentProcessingError
from src.gui.error_dialog import UserNotificationManager, SystemStatusDialog
...
class TestErrorHandlingIntegration:
    ...
    def test_cascading_failure_scenario(self):
        ...
        # 検索サービスも影響を受ける
        search_error = SearchError("データベース障害により検索不可")
