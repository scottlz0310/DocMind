...
from src.gui.search_results import SearchResultsWidget, SearchResultItemWidget, SortOrder
...
class TestSearchResultsIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # 多様なテストデータを作成
        self.mixed_results = []
        file_types = [FileType.PDF, FileType.WORD, FileType.EXCEL, FileType.MARKDOWN, FileType.TEXT]
