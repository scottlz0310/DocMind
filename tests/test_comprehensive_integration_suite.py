...
""",
    ...
    def _test_folder_indexing(self):
        ...
        try:
            ...
            worker.progress_updated.connect(
                lambda msg, current, total: progress_signals.append(
                    (msg, current, total)
                )
            )
    ...
    def _test_search_functionality(self):
        ...
        try:
            ...
            # 全文検索テスト
            text_results = self.search_manager.search(
                "検索テスト", SearchType.FULL_TEXT
            )
        ...
        try:
            ...
            with patch.object(self.document_processor, "process_file") as mock_process:
                ...
                error_cases["file_processing_error"] = {
                    ...
                    "success": len(completion_signals)
                    > 0,  # エラーがあっても完了することを確認
                }
            ...
            return {"success": overall_success, "error_cases": error_cases}
    ...
    def _test_performance(self):
        ...
        try:
            ...
            if completion_signals:
                ...
                # パフォーマンス要件の確認
                performance_ok = (
                    processing_time < 60  # 60秒以内
                    and files_per_second > 0.5  # 0.5ファイル/秒以上
                )
    ...
    def _generate_test_report(self):
        ...
        report_data = {
            ...
            "execution_time": {
                ...
                "end": (
                    self.test_results["end_time"].isoformat()
    ...
    def test_resource_management(self):
        ...
        assert (
            thread_leak <= 1
        ), f"スレッドリークが検出されました: {thread_leak}個のスレッドが残存"
