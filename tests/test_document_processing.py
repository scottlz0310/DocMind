...
"""
    ...
    def test_is_supported_file(self):
        ...
        assert self.processor.is_supported_file("test.docx") == True
        assert self.processor.is_supported_file("test.xlsx") == True
        assert self.processor.is_supported_file("test.md") == True
        assert self.processor.is_supported_file("test.txt") == True
        assert self.processor.is_supported_file("test.unknown") == False
        assert self.processor.is_supported_file("test") == False
