...
class TestTestDatasetManager(unittest.TestCase):
    ...
    def test_create_standard_dataset(self, mock_generator_class):
        ...
        dataset_info = manager.create_standard_dataset(
            name="test_standard", file_count=100
        )
    ...
    def test_create_large_dataset(self, mock_generator_class):
        ...
        # 大規模データセットの作成
        dataset_info = manager.create_large_dataset(name="test_large", file_count=50000)
    ...
    def test_create_edge_case_dataset(self, mock_generator_class):
        ...
        dataset_info = manager.create_edge_case_dataset(
            name="test_edge_case", file_count=500
        )
    ...
    def test_dataset_management(self):
        ...
        metrics = DatasetMetrics(
            total_files=100, total_size_mb=50.0, file_types={"txt": 50, "md": 50}
        )
    ...
    def test_dataset_validation(self):
        ...
        # データセット情報を作成
        metrics = DatasetMetrics(
            total_files=5, total_size_mb=0.001, file_types={"txt": 5}
        )

        config = TestDatasetConfig(
            dataset_name="validation_test", output_directory=dataset_dir, file_count=5
        )
    ...
    def test_config_persistence(self):
        ...
        # テスト用のデータセット情報を作成
        metrics = DatasetMetrics(
            total_files=10, total_size_mb=5.0, file_types={"txt": 10}
        )
