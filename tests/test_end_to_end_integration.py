...
class TestEndToEndWorkflow:
    ...
    def test_complete_document_indexing_workflow(self):
        ...
        processed_docs = []
        all_files = []
        for file_type, files in self.sample_documents.items():
    ...
    def test_error_recovery_workflow(self):
        ...
        try:
            doc = self.document_processor.process_file(invalid_path)
        ...
        with patch.object(self.db_manager, 'add_document') as mock_add:
            ...
            try:
                ...
                result = self.db_manager.add_document(test_doc)
    ...
    def test_large_dataset_workflow(self, large_document_set):
        ...
        processed_count = 0
        all_files = []
        for file_type, files in large_document_set.items():
        ...
        results = self.search_manager.search("テスト", SearchType.FULL_TEXT)
