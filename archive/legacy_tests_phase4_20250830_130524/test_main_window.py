...
class TestMainWindow:
    ...
    def setup_method(self):
        ...
        self.main_window.folder_tree_container.get_selected_folder = Mock(
            return_value=None
        )
        ...
        self.main_window._rebuild_index = MainWindowClass._rebuild_index.__get__(
    ...
    def test_rebuild_index_success(self):
        ...
        self.main_window.folder_tree_container.get_selected_folder.return_value = (
            test_folder
        )

        # スレッド開始が成功する状態をモック
        self.main_window.thread_manager.start_indexing_thread.return_value = (
            "test_thread_id"
        )
        ...
        self.main_window.timeout_manager.start_timeout.assert_called_once_with(
            "test_thread_id"
        )
